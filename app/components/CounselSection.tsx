      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          ...
          <div className="flex flex-col gap-6">
            ...
            >
              Tell me about the{' '}
              <em style={{ color: '#D4AF35', fontStyle: 'italic' }}>journey you imagine.</em>
            </h2>

            {/* Chat interface */}
            <div
              className="rounded-2xl p-5 flex flex-col gap-4"
              style={{ backgroundColor: '#F3F7F8', border: '1px solid #BFDDE7' }}
            >
              {/* Soma bubble */}
              <div className="flex flex-col gap-2">
                <span
                  className="text-xs tracking-widest uppercase"
                  style={{ fontFamily: "'DM Sans', system-ui, sans-serif", color: '#D4AF35', letterSpacing: '0.15em' }}
                >
                  Soma · Your Guide
                </span>
                <div
              ...
              <div className="flex flex-col items-end gap-2">
                ...
                >
                  <p
                    className="text-sm leading-relaxed"
                    style={{ fontFamily: "'DM Sans', system-ui, sans-serif", color: '#2D2F33', fontWeight: 300 }}
                  >
              ...
              <div
                ...
                style={{ backgroundColor: '#BFDDE7', border: '1px solid #BFDDE7' }}
              >
                <p
                ...
                <div className="flex flex-col gap-2 mb-3">
                  {[
                    ...
                    <div key={item} className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full flex-shrink-0" style={{ backgroundColor: '#D4AF35' }} />
                      <p
            ...
            <div className="flex flex-wrap gap-2">
              {['Make it slower', 'Add Nepal', 'Less travel', 'More yoga'].map((chip) => (
                <button
                  key={chip}
                  className="px-4 py-2 rounded-full text-sm transition-all duration-200 hover:border-metallic-gold hover:text-metallic-gold"
                  style={{
                    fontFamily: "'DM Sans', system-ui, sans-serif",
                    color: '#2D2F33',
            ...
            <div
              ...
              style={{ backgroundColor: '#F3F7F8', border: '1.5px solid #BFDDE7' }}
            >
              <input
                type="text"
